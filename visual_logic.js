...
registerOnClick('spear black', false, false, [0,1,2], false, function(event) {
    assignMat('metal stand', 'black', undefined);
}, function(event) {});

registerOnClick('spear chrome', false, false, [0,1,2], false, function(event) {
    assignMat('metal stand', 'chrome', undefined);
}, function(event) {});

registerOnClick('spear white', false, false, [0,1,2], false, function(event) {
    assignMat('metal stand', 'white', undefined);
}, function(event) {});

registerOnClick('slab 1', false, false, [0,1,2], false, function(event) {
    replaceTexture('woodmaterailoo', 'woodmaterial1', './wood_basecolor_1.jpg', false, function() {});
}, function(event) {});

registerOnClick('slab 2', false, false, [0,1,2], false, function(event) {
    replaceTexture('woodmaterailoo', 'woodmaterial1', 'wood_basecolor_2.jpg', false, function() {});
}, function(event) {});

registerOnClick('slab 3', false, false, [0,1,2], false, function(event) {
    replaceTexture('woodmaterailoo', 'woodmaterial1', 'wood_basecolor_3.jpg', false, function() {});
}, function(event) {});
